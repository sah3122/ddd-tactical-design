...
public class MenuRestController {
    ...
    public ResponseEntity<MenuResponseDto> create(@RequestBody final MenuRequestDto menuRequestDto) {
        final MenuResponseDto created = menuService.create(menuRequestDto);
